    ...
    const initWebRoute = (app) => {
        ...
        router.get('/listGuest', mdw.isAuth, user.getAllGuest)
        router.get('/detailGuest/:username', user.detailGuest)
        router.get('/editGuest/:username', user.editGuest)
        router.post('/updateGuest/:username', user.updateGuest)
        router.delete('/deleteGuest/:username', user.deleteGuest)
